...
%% @end
setup() ->
  oc_stat_measure:new(cowboy_early_errors, "Counts Cowboy early errors.", req),
  oc_stat_measure:new(cowboy_protocol_upgrades, "Counts protocol upgrades.", req),
  oc_stat_measure:new(cowboy_request_duration, "Cowboy request duration.", native_time_unit),
  oc_stat_measure:new(cowboy_spawned_processes, "Counts spawned processes.", req),
  oc_stat_measure:new(cowboy_errors, "Counts request errors.", req),
